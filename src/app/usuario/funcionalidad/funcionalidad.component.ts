...
export class FuncionalidadComponent implements OnInit {
  ...
  selectedFuncionalidad: Funcionalidad = {};
  ...
  setActiveFuncionalidad(funcionalidad: Funcionalidad): void {
    this.selectedFuncionalidad = funcionalidad;
    console.log(this.selectedFuncionalidad);
  }
